...
abstract class AppLocalizations {
  ...
  /// No description provided for @pcNavAnnouncements.
  ///
  /// In pt, this message translates to:
  /// **'Anúncios'**
  String get pcNavAnnouncements;

  /// No description provided for @pcNavReceivables.
  ///
  /// In pt, this message translates to:
  /// **'A receber'**
  String get pcNavReceivables;

  /// No description provided for @pcNavInvestments.
  ///
  /// In pt, this message translates to:
  /// **'Investimentos'**
  String get pcNavInvestments;

  /// No description provided for @pcInstallmentPlanTitle.
  ///
  /// In pt, this message translates to:
  /// **'Plano de parcelas'**
  String get pcInstallmentPlanTitle;

  /// No description provided for @pcEmergencyPlanTitle.
  ///
  /// In pt, this message translates to:
  /// **'Plano de reserva'**
  String get pcEmergencyPlanTitle;

  /// No description provided for @pcDisplayNameTitle.
  ///
  /// In pt, this message translates to:
  /// **'Nome de exibição'**
  String get pcDisplayNameTitle;

  /// No description provided for @pcManageCategoriesTitle.
  ///
  /// In pt, this message translates to:
  /// **'Categorias de despesa'**
  String get pcManageCategoriesTitle;

  /// No description provided for @pcAnnouncementsEmpty.
  ///
  /// In pt, this message translates to:
  /// **'Sem anúncios activos.'**
  String get pcAnnouncementsEmpty;

  /// No description provided for @pcReceivablesEmpty.
  ///
  /// In pt, this message translates to:
  /// **'Sem valores a receber.'**
  String get pcReceivablesEmpty;

  /// No description provided for @pcInvestmentsTitle.
  ///
  /// In pt, this message translates to:
  /// **'Investimentos'**
  String get pcInvestmentsTitle;

  /// No description provided for @pcInvestmentsAddPrincipal.
  ///
  /// In pt, this message translates to:
  /// **'Aportar capital'**
  String get pcInvestmentsAddPrincipal;

  /// No description provided for @pcInvestmentsPrincipalHint.
  ///
  /// In pt, this message translates to:
  /// **'Valor a acrescentar (R\$)'**
  String get pcInvestmentsPrincipalHint;

  /// No description provided for @pcPlansTitle.
  ///
  /// In pt, this message translates to:
  /// **'Planos de reserva'**
  String get pcPlansTitle;

  /// No description provided for @pcPlansEmpty.
  ///
  /// In pt, this message translates to:
  /// **'Sem planos adicionais. Usa a reserva simples ou cria um plano na API.'**
  String get pcPlansEmpty;

  /// No description provided for @pcPlanMonthsTitle.
  ///
  /// In pt, this message translates to:
  /// **'Meses do plano'**
  String get pcPlanMonthsTitle;

  /// No description provided for @pcShoppingListNewRouteTitle.
  ///
  /// In pt, this message translates to:
  /// **'Nova lista'**
  String get pcShoppingListNewRouteTitle;
}
